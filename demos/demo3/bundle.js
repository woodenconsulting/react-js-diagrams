...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DiamondNodeModel__ = __webpack_require__(52);
...
var DiamonNodeWidget = (_temp = _class = function (_React$Component) {
	...
	_createClass(DiamonNodeWidget, [{
		...
		value: function render() {
			...
			//left node
			__WEBPACK_IMPORTED_MODULE_0_react__["DOM"].div({ style: { position: 'absolute', zIndex: 10, top: this.props.size / 2 - 5 } }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_main__["q" /* PortWidget */], { name: 'left', node: this.props.node })),

			//top node
			__WEBPACK_IMPORTED_MODULE_0_react__["DOM"].div({ style: { position: 'absolute', zIndex: 10, left: this.props.size / 2 - 8 } }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_main__["q" /* PortWidget */], { name: 'top', node: this.props.node })),

			//right
			__WEBPACK_IMPORTED_MODULE_0_react__["DOM"].div({ style: { position: 'absolute', zIndex: 10, left: this.props.size - 10, top: this.props.size / 2 } }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_main__["q" /* PortWidget */], { name: 'right', node: this.props.node })),

			//bottom
			__WEBPACK_IMPORTED_MODULE_0_react__["DOM"].div({ style: { position: 'absolute', zIndex: 10, left: this.props.size / 2 - 8, top: this.props.size - 10 } }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_main__["q" /* PortWidget */], { name: 'bottom', node: this.props.node })));
		}
	}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_main__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__DiamondNodeModel__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__DiamondWidgetFactory__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DiamondInstanceFactories__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__test_scss__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DiamondPortModel__ = __webpack_require__(68);
...
}(__WEBPACK_IMPORTED_MODULE_0__src_main__["g" /* NodeModel */]);
...
}(__WEBPACK_IMPORTED_MODULE_0__src_main__["o" /* PortModel */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_main__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DiamondNodeModel__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DiamondPortModel__ = __webpack_require__(68);
...
}(__WEBPACK_IMPORTED_MODULE_0__src_main__["p" /* AbstractInstanceFactory */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_main__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DiamondNodeWidget__ = __webpack_require__(100);
